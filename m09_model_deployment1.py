...
clf = joblib.load(os.path.dirname(__file__) + '/movie_gender_clf.pkl') 
vect1 = joblib.load(os.path.dirname(__file__) + '/movie_gender_vect1.pkl') 
...
def predict_gender(plot,title,year):
